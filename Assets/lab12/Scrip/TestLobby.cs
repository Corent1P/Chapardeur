...
public class TestLobby : MonoBehaviour
{
    ...
    public LobbyChatManager lobbyChatManager;
        ...
        if (JoinedLobby != null)
        {
            ...
            if (JoinedLobby.Data[KEY_RELAYCODE].Value != "0")
            {
                if (!IsLobbyHost())
                {
                    ...
                    {
                        await relayManager.JoinRelay(JoinedLobby.Data[KEY_RELAYCODE].Value);
                    }
                }
                JoinedLobby = null;
            }
